...
// TODO - ERD - Consider mentioning License/Copyright murkiness with LLMs. (Probably outside scope of this document.)
...
// TODO - ERD - Expand on "Open contribution process", mention AI use policy?
| Alignment with WMO standards (BUFR, GRIB2, NetCDF)
| Decision-making process documented
// TODO - ERD - Expand on "Decision-making process documented", mention AI use policy?
