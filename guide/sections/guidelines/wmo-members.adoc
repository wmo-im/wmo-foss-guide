...
* **Technical capacity development**: Community involvement within FOSS projects can foster career growth, professional recognition, networking and collaboration. In turn this can lead to increased techical capacity within the Members NMHSs and other organisations.
