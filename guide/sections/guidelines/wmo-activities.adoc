...
NOTE: This section describes the OSPO model as an institutional mechanism, generally, and considers how it could be
applied within WMO. It is descriptive rather than prescriptive - establishing an OSPO would be a decision for WMO's
governing bodies.
...
* **WMO Secretariat**: Provides the institutional mandate and home for the OSPO, ensures FOSS governance is embedded within WMO's broader programme management and regulatory framework, and maintains the WMO GitHub organizationfootnote:[https://github.com/World-Meteorological-Organization] as the repository for free and open source software developed by WMO and its Members.
